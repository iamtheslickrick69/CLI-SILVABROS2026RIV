...
export const metadata: Metadata = {
  title: "Solar Insights & Guides | California Solar Education | RIV Solar",
  description: "Expert guides on California solar panels, NEM 3.0, battery storage, tax credits, financing options, and real savings. Learn everything about going solar in 2026.",
  keywords: ["California solar", "NEM 3.0", "solar tax credit", "solar battery storage", "PG&E rates", "SDG&E rates", "SCE rates", "solar financing", "solar installation"],
  openGraph: {
    title: "Solar Insights & Guides | RIV Solar",
    description: "30+ expert guides on California solar. Learn about NEM 3.0, tax credits, battery storage, and how much you can save.",
    type: "website",
  ...
  twitter: {
    ...
    title: "Solar Insights & Guides | RIV Solar",
    description: "30+ expert guides on California solar. Learn about NEM 3.0, tax credits, battery storage, and savings.",
  },
  alternates: {
...
function generateSchema() {
  ...
  const organizationSchema = {
    ...
    "description": "California's trusted residential solar company. AI-powered tools, transparent pricing, 25-year warranty.",
    "areaServed": {
      "@type": "State",
      "name": "California"
    },
